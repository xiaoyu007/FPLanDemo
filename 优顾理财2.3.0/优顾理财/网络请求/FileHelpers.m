...
//  Copyright (c) 2013年 Himalayas Technology&Science Company
//  CO.,LTD-重庆喜玛拉雅科技有限公司. All rights reserved.
//
...
NSString *pathForURL(NSURL *aURL) {
  return pathInCacheDirectory(
      [NSString stringWithFormat:@"com.xmly/cachedImage-%lu",
                                 (unsigned long)[[aURL description] hash]]);
}
...
NSString *hashCodeForURL(NSURL *aURL) {
  return [NSString
      stringWithFormat:@"%lu", (unsigned long)[[aURL description] hash]];
}
