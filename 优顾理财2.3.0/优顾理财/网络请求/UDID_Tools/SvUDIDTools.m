...
static const char kKeyChainUDIDAccessGroup[] = "com.JHSS.ios.YGLC.YOUGUU.YULING";
...
+ (NSString*)getUDIDFromKeyChain
{
    ...
    dictForQuery[(id) kSecAttrGeneric] = keychainItemID;
...
#else
        dictForQuery[(id) kSecAttrAccessGroup] = accessGroup;
#endif
    }
...
+ (BOOL)settUDIDToKeyChain:(NSString*)udid
{
    ...
    dictForAdd[(id) kSecAttrAccount] = @"";
    dictForAdd[(id) kSecAttrLabel] = @"";
    ...
    if (accessGroup != nil)
    {
        ...
        // simulator will return -25243 (errSecNoAccessForItem).
#else
        dictForAdd[(id) kSecAttrAccessGroup] = accessGroup;
#endif
    }
...
+ (BOOL)updateUDIDInKeyChain:(NSString*)newUDID
{
    ...
    if (queryResult) {
        ...
        updateItem[(id) kSecClass] = (id) kSecClassGenericPassword;
