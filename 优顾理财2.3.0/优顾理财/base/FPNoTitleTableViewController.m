//
//  FPNoTitleTableViewController.m
//  优顾理财
//
...
#import "FPNoTitleTableViewController.h"

@implementation FPNoTitleTableViewController
- (id)initWithFrame:(CGRect)frame AndRefreshLable:(NSString *)labletext {
  ...
  if (self) {
    ...
    _tableView = [[PullingRefreshTableView alloc] initWithFrame:CGRectMake(0, 0, 320, self.childView.height)
