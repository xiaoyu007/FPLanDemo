...
/**
 The float value used to for calculate the `filled in` fraction of the inner
 circle,
  0 ≤ progress ≤ 1.
 */
...
/**
 The duration for animations displayed after calling
 `displayOperationWillTriggerAnimation` and `displayOperationDidFinishAnimation`
 methods.
...
/**
 This flag indicates wheter or not 'displayDownloadDidFinishAnimation' method is
 called when 'progress' property is set to 1.,
 This is YES by default.
 */
@property(assign, nonatomic)
    BOOL triggersDownloadDidFinishAnimationAutomatically;

/**
 makes the outer faded out circle radius expand until it circumscribes the
 DAProgressOverlayView bounds
 */
- (void)displayOperationDidFinishAnimation;

/**
 Changes radiuses of the inner and outer circles from zero to the corresponding
 values, calculated from 'innerRadiusRatio' and 'outerRadiusRatio' properties.
 */
