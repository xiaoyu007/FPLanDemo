...
/** Retrieve next row for result set.
 ...
 You must always invoke `next` before attempting to access the values returned
...
/** Did the last call to `<next>` succeed in retrieving another row?
 ...
 @return `YES` if the last call to `<next>` succeeded in retrieving another
 record; `NO` if not.
 ...
 this method may return `NO`, whether there is another row of data or not.
 */
...
/** Result set object for column.
 ...
 @return Either `NSNumber`, `NSString`, `NSData`, or `NSNull`. If the column was
 `NULL`, this returns `[NSNull null]` object.
...
or after you close the
result set, make sure to make a copy of the data first (or just use
`<dataForColumn:>`/`<dataForColumnIndex:>`)
If you don't, you're going to be in a world of hurt when you try and use the
data.
