...
/** 理财超市首页 */
@interface FPFundShopViewController
    : FPNoTitleViewController  <UIScrollViewDelegate, PullingRefreshTableViewDelegate, UITableViewDataSource, UITableViewDelegate> {
  /** 承载滚动视图 */
...
/** 顶部视图 */
@property(nonatomic, strong) FPFinacingShopHeadView *headView;
/** 风险评测 */
