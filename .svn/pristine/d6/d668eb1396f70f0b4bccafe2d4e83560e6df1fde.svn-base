...
/** Return `int` value for query
 ...
 @param ... A list of parameters that will be bound to the `?` placeholders in
 the SQL query.
...
/** Validate SQL statement
 ...
 @param error This is a pointer to a `NSError` object that will receive the
 autoreleased `NSError` object if there was any error. If this is `nil`, no
 `NSError` result will be returned.
